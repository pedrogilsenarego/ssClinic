...
export const stripeProduction =
  "https://us-central1-octo-29041.cloudfunctions.net/api/payments/creditCard";
export const stripeLocal =
  "http://127.0.0.1:5001/favre-bulle/us-central1/api/payments/creditCard";
